...
namespace SalesAndReturnSystem.DAL;

public partial class SalesAndReturnContext : DbContext
{
    public SalesAndReturnContext(DbContextOptions<SalesAndReturnContext> options)
        : base(options)
    {
    }
